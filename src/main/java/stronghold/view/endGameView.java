...
public class endGameView {
    ...
    private static String pathToRegexJSON = "src/main/java/stronghold/Regex/endGameMenuRegex.json";
    ...
    public static void Output(String code, Object... params) {
        String pathToJSON = "src/main/java/stronghold/response/endGameMenuResponses.json";
