...
public class signUpLoginView extends menuView{
    private static String pathToRegexJSON = "src/main/java/stronghold/Regex/signUpLoginRegex.json";
...
//                System.out.println(nickname);
    ...
    public static void output(String code, Object... params){
        String pathToJSON = "src/main/java/stronghold/response/signUpLoginMenuResponses.json";
