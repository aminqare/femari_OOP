...
import static controller.profileMenuController.*;

public class profileMenuView {

    private static String pathToRegexJSON = "src/Regex/ProfileMenuRegex.json";
        ...
        while(true) {
            ...
            if (input.matches("\\s*back\\s*")) {
                ...
                profileMenuView.output("show", currentUser.getUsername(),
                        ...
                        currentUser.getSpecialCardsDB().getCards(),
    ...
    public static void output(String code, Object... params){
        String pathToJSON = "src/response/ProfileMenuResponses.json";
