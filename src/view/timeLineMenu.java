...
long startTime=System.currentTimeMillis();
        while(index <= 21){
            ...
            if(currentTime>=stepTime+stepTime*index){
                ...
                if(currentSuperGame.getCurrentGame().getPlayerOne().getGameBoard().getType().get(index - 1).equals("cards") &&
                !isHeal(playerTwo, index - 1)){
                    ...
                    else if(playerOne.getGameBoard().getType().get(index-1).equals(specialCard) && playerTwo.getGameBoard().getType().get(index - 1) == null){
                        if(playerOne.getGameBoard().getType().get(index-1).equals("heal")){
                            playerOne.IncreaseHP();
                            cardOne = "Heal";
                            cardTwo = "null";
                    ...
                    else if(playerTwo.getGameBoard().getType().get(index-1).equals(specialCard) && playerOne.getGameBoard().getType().get(index - 1) == null){
                        if(playerTwo.getGameBoard().getType().get(index-1).equals("heal")){
                            playerTwo.IncreaseHP();
                            cardTwo = "Heal";
                            cardOne = "null";
    ...
    public static void Output(String code, Object... params) {
        String pathToJSON = "src/response/timeLineMenuResponses.json";
